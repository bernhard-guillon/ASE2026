...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--neural-lane-mode",
        choices=["base", "4x", "8x", "8xpmac", "8xpmac2", "8xpmac3"],
        default="base",
        help="For x7b neural ops: matvec variant to emit (base=nmatvecx, 4x=nmatvec4x, 8x=nmatvec8x, 8xpmac=nmatvec8xp, 8xpmac2=nmatvec8xp2, 8xpmac3=nmatvec8xp3)",
    )
