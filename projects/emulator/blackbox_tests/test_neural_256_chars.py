...
class NeuralCharTest:
    ...
    def build_neural_elf(self):
        ...
        if lane_mode not in ("base", "4x", "8x", "8xpmac", "8xpmac2", "8xpmac3"):
            raise RuntimeError(f"Unsupported NEURAL_LANE_MODE '{lane_mode}' (expected base, 4x, 8x, 8xpmac, 8xpmac2, or 8xpmac3)")
