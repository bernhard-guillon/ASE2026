...
TEST_F(ExecutionTest, NeuralCustom3NMatvec8xp2ExecutesAndSetsStatus) {
    const uint32_t desc = 0x100;
    const uint32_t input = 0x140;
    const uint32_t weights = 0x180;
    const uint32_t bias = 0x1C0;
    ...
    cpu.setReg(5, desc); // rs1 for nmatvec8xp2
    // opid=7 (nmatvec8xp2), rd=x6, rs1=x5, opcode=0x7B
    uint32_t raw = (7u << 27) | (0u << 22) | (0u << 17) | (5u << 12) | (6u << 7) | 0x7Bu;
    Instruction instr = InstructionDecoder::decode(raw);
    cpu.execute(instr, memory);
...
TEST_F(ExecutionTest, NeuralCustom3NMatvec8xp3ExecutesAndSetsStatus) {
    const uint32_t desc = 0x100;
    const uint32_t input = 0x140;
    const uint32_t weights = 0x180;
    const uint32_t bias = 0x1C0;
    ...
    cpu.setReg(5, desc); // rs1 for nmatvec8xp3
    // opid=8 (nmatvec8xp3), rd=x6, rs1=x5, opcode=0x7B
    uint32_t raw = (8u << 27) | (0u << 22) | (0u << 17) | (5u << 12) | (6u << 7) | 0x7Bu;
    Instruction instr = InstructionDecoder::decode(raw);
    cpu.execute(instr, memory);
...
TEST_F(ExecutionTest, NeuralCustom3NMatvec8xp4ExecutesAndSetsStatus) {
    const uint32_t desc = 0x100;
    const uint32_t input = 0x140;
    const uint32_t weights = 0x180;
    const uint32_t bias = 0x1C0;
    ...
    cpu.setReg(5, desc); // rs1 for nmatvec8xp4
    // opid=9 (nmatvec8xp4), rd=x6, rs1=x5, opcode=0x7B
    uint32_t raw = (9u << 27) | (0u << 22) | (0u << 17) | (5u << 12) | (6u << 7) | 0x7Bu;
    Instruction instr = InstructionDecoder::decode(raw);
    cpu.execute(instr, memory);
