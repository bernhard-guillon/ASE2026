...
mod tests {
    ...
    #[test]
    fn test_encode_nmatvec8xp2_opcode_and_opid() {
        let instr = Instruction::NType {
            mnemonic: "nmatvec8xp2.f32".to_string(),
            rd: Register::X6,
            rs1: Register::X5,
            rs2: Register::X31,
            rs3: Register::X31,
    ...
    #[test]
    fn test_encode_nmatvec8xp3_opcode_and_opid() {
        let instr = Instruction::NType {
            mnemonic: "nmatvec8xp3.f32".to_string(),
            rd: Register::X6,
            rs1: Register::X5,
            rs2: Register::X31,
            rs3: Register::X31,
