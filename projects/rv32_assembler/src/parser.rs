...
impl Parser {
    pub fn parse_instruction(tokens: &[Token]) -> Result<Option<Instruction>> {
        ...
        match mnemonic.as_str() {
            ...
            "nmatvec.f32" | "nmatvecx.f32" | "nmatvec4x.f32" | "nmatvec8x.f32" | "nmatvec8xp.f32" | "nmatvec8xp2.f32" | "nmatvec8xp3.f32" | "nmatvec8xp4.f32" => {
...
mod tests {
    ...
    #[test]
    fn test_parse_nmatvec8xp_f32() {
        let tokens = crate::lexer::tokenize("NMATVEC8XP.F32 t1, t0").unwrap();
        let instr = Parser::parse_instruction(&tokens).unwrap();
        ...
        match instr {
            Some(Instruction::NType {
                ...
                assert_eq!(mnemonic, "nmatvec8xp.f32");
                assert_eq!(rd, Register::X6);
                assert_eq!(rs1, Register::X5);
                assert_eq!(rs2, Register::X0);
                assert_eq!(rs3, Register::X0);
    ...
    #[test]
    fn test_parse_nmatvec8xp2_f32() {
        let tokens = crate::lexer::tokenize("NMATVEC8XP2.F32 t1, t0").unwrap();
        let instr = Parser::parse_instruction(&tokens).unwrap();
    ...
    #[test]
    fn test_parse_nmatvec8xp4_f32() {
        let tokens = crate::lexer::tokenize("NMATVEC8XP4.F32 t1, t0").unwrap();
        let instr = Parser::parse_instruction(&tokens).unwrap();
        ...
        match instr {
            Some(Instruction::NType {
                ...
                assert_eq!(mnemonic, "nmatvec8xp4.f32");
                assert_eq!(rd, Register::X6);
                assert_eq!(rs1, Register::X5);
                assert_eq!(rs2, Register::X0);
                assert_eq!(rs3, Register::X0);
